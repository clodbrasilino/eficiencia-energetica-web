...
/**
 * Servlet implementation class ServletAlterarSenhaGerente
 */
public class ServletAlterarSenhaGerente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletAlterarSenhaGerente() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(senhaAtual.equals(u.getSenha())){
			...
			if(confirmacaoSenha.equals(novaSenha)){
				...
				response.getWriter().println("<script>window.location.href='/"+getServletContext().getInitParameter("app-name")+"/JSP/gerente/alterarDados.jsp'</script>");
			}else{
